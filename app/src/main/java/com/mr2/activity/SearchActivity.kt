...
import com.mr2.databinding.ActivitySearchBinding
...
class SearchActivity : AppCompatActivity(), SearchView.OnQueryTextListener, View.OnClickListener {
    ...
    private fun initView() {
        val searchPlateId: Int = findViewById<SearchView>(R.id.search_notes).context.resources
            .getIdentifier("android:id/search_plate", null, null)
        val searchPlate: View =
            findViewById<SearchView>(R.id.search_notes).findViewById(searchPlateId)
        searchPlate.setBackgroundColor(Color.TRANSPARENT)

        val linearLayout1 = findViewById<SearchView>(R.id.search_notes).getChildAt(0) as LinearLayout
        ...
        findViewById<SearchView>(R.id.search_notes).setOnQueryTextListener(this)
        findViewById<SearchView>(R.id.search_notes).isFocusable = false
    ...
    private fun initListener() {
        ...
        findViewById<ImageView>(R.id.nib_back).setOnClickListener(this)
    }
